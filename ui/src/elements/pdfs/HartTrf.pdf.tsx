    ...
    <Document>
      <Page style={styles.page}>
        ...
        >
          ...
          >
            <View
              style={[
                ...
                { borderRight: 1, borderRightColor: "#ccc" },
              ]}
            >
              <Text>Address</Text>
          ...
          >
            <View style={[styles.innerContainer, {}]}>
              ...
              >
                ...
                <Text style={[styles.valueText]}>Bagmati</Text>
              </View>
          ...
          >
            <View style={[styles.innerContainer, { display: "flex" }]}>
              <View style={[styles.innerContainer, { display: "flex" }]}>
                <View
                  style={[
                    styles.innerContainer,
                ...
                >
                  ...
                  <Text style={[styles.valueText]}>1231239182930</Text>
                </View>
              </View>
              ...
              >
                <View
                  style={[
                    styles.innerContainerCol,
                    { flex: 2, borderRightWidth: 1, borderRightColor: "#ccc" },
                  ]}
                >
                  <Text style={[styles.labelText]}>City</Text>
          ...
          >
            <View style={[styles.innerContainer, { display: "flex" }]}>
              ...
              >
                ...
                <Text style={[styles.valueText]}>Clinic contact addresss</Text>
              </View>
              <View
                style={[
                  styles.flex_row,
              ...
              >
                <View style={[styles.innerContainerCol, {}]}>
                  ...
                  >
                    ...
                    >
                      <View style={[styles.rectangle, { marginTop: 4 }]}></View>
                      <Text style={[styles.valueText]}>Hispanic or Latino</Text>
                    </View>
                    ...
                    >
                      <View style={[styles.rectangle, { marginTop: 4 }]}></View>
                      <Text style={[styles.valueText]}>Asian</Text>
                    </View>
                    ...
                    >
                      <View style={[styles.rectangle, { marginTop: 4 }]}></View>
                      <Text style={[styles.valueText]}>Other</Text>
                    </View>
                  </View>
                </View>
              </View>
